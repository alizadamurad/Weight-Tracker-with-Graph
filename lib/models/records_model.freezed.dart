...
abstract class $RecordsCopyWith<$Res> {
  ...
  @useResult
  $Res call({DateTime date, int weight, String photoUrl, String note});
}
...
/// @nodoc
@JsonSerializable()
class _$_Records with DiagnosticableTreeMixin implements _Records {
  _$_Records(
      {required this.date,
  ...
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'Records(date: $date, weight: $weight, photoUrl: $photoUrl, note: $note)';
  }
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties
      ..add(DiagnosticsProperty('type', 'Records'))
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, date, weight, photoUrl, note);
...
abstract class _Records implements Records {
  factory _Records(
      ...
      required final String note}) = _$_Records;
